...
@section('title','Your inactive medical officers!')
@section('custom_js')
...
@section('content')
    <div class="row">
        <div class="col-sm-8 col-6">
            <h4 class="page-title">Inactive Medical Officers</h4>
        </div>
...
{{--                                <h2><a href="{{route('bloodBank.mo.show',$medical_officer->id)}}">{{$medical_officer->name}}</a></h2>--}}
                            ...
                            <td>
                                <form method="post" action="{{ route('bloodBank.mo.update',$medical_officer->id) }}">
                                    ...
                                    <button class="btn btn-success m-r-5" onclick="return confirm('Are you confirm to reactivate?')"> Reactive</button>
                                </form>
                            </td>
                            <td class="text-right">
