...
@section('content')
    <div class="row">
        <div class="col-sm-8 col-6">
            <h4 class="page-title">Rejected MO Requests</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <form method="post" action="{{ route('medicalOfficer.updateRequest',$medicalOfficer->id) }}">
                                            ...
                                            <button class="btn btn-outline-warning fa fa-check-circle m-r-5" onclick="return confirm('Are you confirm to change status to pending?')">Reject</button>
                                        </form>
