    ...
    <div class="row filter-row">
        ...
        <div class="col-sm-6 col-md-5 col-lg-5 col-xl-5 col-12">
            <div class="form-group form-focus">
                ...
                <input required name="searchByName" cus-status="pending" id="searchByName" type="text" cus-url="{{route('bloodBank.searchByName')}}" class="form-control floating" >
            </div>
        </div>
        <div class="col-sm-6 col-md-5 col-lg-5 col-xl-5 col-12">
            <div class="form-group form-focus">
                <label class="focus-label">Blood Bank RegistrationNumber</label>
                <input required name="searchByReg" cus-status="pending" id="searchByReg" type="text" cus-url1="{{route('bloodBank.searchByReg')}}" class="form-control floating">
            </div>
        </div>
